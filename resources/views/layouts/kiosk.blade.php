@php
  /**
   *   file       : layout/kiosk1.blade.php
   *   description: main blade for kiosk layout  
   *   created    : rudy.gunawan@polytron.co.id 2020/11/17
   */
...
<body class="hold-transition sidebar-collapse">
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand bg-danger navbar-light elevation-2">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
              <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto align-items-center h-100">
                <li class="nav-item m-0" id="artClock"></li>
                @guest
        ...
        <aside class="main-sidebar sidebar-mini sidebar-light-danger elevation-4">
            <!-- Brand Logo -->
  ...
  <!-- REQUIRED SCRIPTS -->
    ...
    <script>
        ...
        * okCallback: fungsi callback yang dijalankan saat klik OK button, default: null
        ...
        function artConfirmationDo(title, text, okCallback,modalWidth=600) {
        ...
        $(document).ready(function () {
          ...
          window.setTimeout(updateArtClock,500);
        });

        function updateArtClock() {
            var d = new Date();
            $('#artClock').html(d.toLocaleDateString()+' '+d.toLocaleTimeString());
            window.setTimeout(updateArtClock,500);
        }
    </script>
